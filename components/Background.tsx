...
export function Background() {
    ...
    return (
        <div className="fixed inset-0 overflow-hidden pointer-events-none -z-50">
            ...
            <div className={`absolute top-0 -left-4 w-72 h-72 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob dark:opacity-20 ${visuals.blobColors.first}`}></div>
            <div className={`absolute top-0 -right-4 w-72 h-72 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000 dark:opacity-20 ${visuals.blobColors.second}`}></div>
            <div className={`absolute -bottom-8 left-20 w-72 h-72 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000 dark:opacity-20 ${visuals.blobColors.third}`}></div>
